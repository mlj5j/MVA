...
parser.add_argument('-m', '--mode', dest='mode', default='RandS', help='If training on RandS samples, you should put RandS here.  Otherwise do not put anything.')
...
fout = TFile.Open("../Results/BDT_output_{0}_{1}trees_{2}maxdepth.root".format(args.name, args.Ntrees, args.maxdepth),"RECREATE")
...
loader = TMVA.DataLoader("dataset_bdt_{0}_{1}trees_{2}maxdepth".format(args.name, args.Ntrees, args.maxdepth))
...
sigcuts_RandS = TCut('IsRandS==0 && HardMETPt>110 && Photons_isEB[0]==1 && Photons_isEB[1]==1 && mva_Ngoodjets>1 && mva_Photons0Et>80 && mva_Photons1Et>80')
bkgcuts_RandS = TCut('IsRandS==1 && HardMETPt>110 && Photons_isEB[0]==1 && Photons_isEB[1]==1 && mva_Ngoodjets>1 && mva_Photons0Et>80 && mva_Photons1Et>80')
